...
// POST /barbershops - Create a new barbershop (admin only)
router.post('/', requireRole('admin'), barbershopController.createBarbershop);

// PUT /barbershops/:id - Update an existing barbershop (admin or manager)
router.put('/:id', requireRole('admin', 'manager'), barbershopController.updateBarbershop);

// DELETE /barbershops/:id - Delete a barbershop (admin only)
